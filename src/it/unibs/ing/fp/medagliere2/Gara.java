...
public class Gara {
	 ...
	 * 
	 * @param vector
	 *            di nazioni che corrispondono alle 3 nazioni che hanno vinto la
	 *            gara
	 */
	...
	public String toString() {
		return String.format("%s%n Medaglia oro: %s%n Medaglia argento: %s%n Medaglia bronzo:%s", nome,
				risultato.get(0).getNome(), risultato.get(1).getNome(), risultato.get(2).getNome());
	}
