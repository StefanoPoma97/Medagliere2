...
public class ElencoNazioni {
	...
	/**
	 * aggiunge una nazione se non � gi� presente in elenco
	 * 
	 * @param nazione
	 * @return true se � stata aggiunta, false altrimenti
	 */
	...
	/**
	 * metodo che ordina il medagliere con il seguente principio prima gli ori
	 * se due nazioni hanno stesso numero di ori, viene messa prima chi ha pi�
...
//	 }
	 ...
	 * 
	 * @return stringa contenente tutte le nazioni e le rispettive medaglie
	 *         vinte
	 */
